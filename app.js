...
{  
    Fname = document.getElementById('name1').value.toUpperCase();  
    FnameLength = Fname.length;  
     
    Sname = document.getElementById('name2').value.toUpperCase();  
    ...
    {  
        ...
        var txtresult = document.getElementById("display");  
